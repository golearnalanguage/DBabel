  ...
  function renderTable(){
    ...
    for(const u of pageUnits){
      ...
      for(const i of issuesFor(u.id).slice(0,3)){
        ...
        const txt=trUI(issueDisplay(raw));
