...
- [Workflow and source configuration](config/)
...
- [Regression tests](tests/test_reports.py) · [Behavioral evaluation](tests/BEHAVIORAL_EVAL.md)
...
- [Architecture](docs/ARCHITECTURE.md) · [Research basis](docs/RESEARCH_BASIS.md)
